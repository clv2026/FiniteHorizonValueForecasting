...
This repository contains the official implementation accompanying the paper: **_Modular Probabilistic Engagement‑State for Interpretable Finite‑Horizon Revenue Forecasting_** accepted at [ECML PKDD 2026](https://ecmlpkdd.org/2026/).

**Authors:** Stefania Stan, Claudio Ricci, Rolands Repetto, Yuntao Li, Detlef Repplinger, Maximilian Scrase.
